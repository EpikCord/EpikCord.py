...
## Why EpikCord.py when Discord.py is back?
Discord.py is a little bit complicated.EpikCord.py is there because we want beginner developers to feel ease while, at the same time providing advanced developers many advanced features.

...
def message_create(self: Any, data: <class 'dict'>)
...
def json(self: Any, encoding: typing.Optional[str], loads: typing.Callable[[str], typing.Any], content_type: typing.Optional[str])
    Read and decodes JSON response.
def raise_for_status(self: Any)
def read(self: Any)
    Read response payload.
def release(self: Any)
def start(self: Any, connection: Connection)
    Start response processing.
def text(self: Any, encoding: typing.Optional[str], errors: <class 'str'>)
...
def delete(self: Any, url: typing.Union[str, yarl.URL], kwargs: typing.Any)
...
Guild
-----
def create_channel(self: Any, name: <class 'str'>, reason: typing.Optional[str], type: typing.Optional[int], topic: typing.Optional[str], bitrate: typing.Optional[int], user_limit: typing.Optional[int], rate_limit_per_user: typing.Optional[int], position: typing.Optional[int], permission_overwrites: typing.List[typing.Optional[EpikCord.Overwrite]], parent_id: typing.Optional[str], nsfw: typing.Optional[bool])
    Creates a channel.
...
def fetch_guild_preview(self: Any)

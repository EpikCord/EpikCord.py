...
# i have merged both discordutils and EpikCord to make peoples lives easier (dont blame me for copying)
# TODO : make it more better and working
class CEmbedPage(object):
    def __init__(self,ctx,**kwargs):

        self.embeds : List[Embed]=None
        self.ctx = ctx
        self.bot = ctx.bot
        self.pages = 0 
        ...
        self.default_ctrl_emotes = {"first" : "⏮️",
                            "forward": "⏩",
                            "stop": "⏹️",
                            "rewind": "⏪",
                            "last": "⏭️"
                            }
        self.default_cmds = ["first", "forward", "stop", "rewind", "last"]
        self.cmds = kwargs.get("commands", self.default_cmds)
        self.ctrl_emotes = kwargs.get("ctrl_emotes", self.default_ctrl_emotes)
